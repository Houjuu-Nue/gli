namespace gli
{
	...
	storage_linear::storage_linear(format_type Format, extent_type const& Extent, size_type Layers, size_type Faces, size_type Levels)
		: Layers(Layers)
		, Faces(Faces)
		, Levels(Levels)
	...
	bool storage_linear::empty() const
	{
		return this->Data.empty();
	}

	storage_linear::size_type storage_linear::layers() const
	{
		return this->Layers;
	}

	storage_linear::size_type storage_linear::faces() const
	{
		return this->Faces;
	}

	storage_linear::size_type storage_linear::levels() const
	{
		return this->Levels;
	}

	storage_linear::size_type storage_linear::block_size() const
	{
		return this->BlockSize;
	}

	storage_linear::extent_type storage_linear::block_extent() const
	{
		return this->BlockExtent;
	}

	storage_linear::extent_type storage_linear::block_count(size_type Level) const
	{
	...
	storage_linear::extent_type storage_linear::extent(size_type Level) const
	{
		GLI_ASSERT(Level >= 0 && Level < this->Levels);
	...
	storage_linear::size_type storage_linear::size() const
	{
	...
	storage_linear::data_type* storage_linear::data()
	{
		GLI_ASSERT(!this->empty());
	...
	storage_linear::size_type storage_linear::base_offset(size_type Layer, size_type Face, size_type Level) const
	{
		GLI_ASSERT(!this->empty());
	...
	storage_linear::size_type storage_linear::image_offset(extent1d const& Coord, extent1d const& Extent) const
	{
		GLI_ASSERT(glm::all(glm::lessThan(Coord, Extent)));
		return static_cast<size_t>(Coord.x);
	}

	storage_linear::size_type storage_linear::image_offset(extent2d const& Coord, extent2d const& Extent) const
	{
		GLI_ASSERT(glm::all(glm::lessThan(Coord, Extent)));
		return static_cast<size_t>(Coord.x + Coord.y * Extent.x);
	}

	storage_linear::size_type storage_linear::image_offset(extent3d const& Coord, extent3d const& Extent) const
	{
		GLI_ASSERT(glm::all(glm::lessThan(Coord, Extent)));
		return static_cast<storage_linear::size_type>(Coord.x + Coord.y * Extent.x + Coord.z * Extent.x * Extent.y);
	}

	void storage_linear::copy(
	...
	storage_linear::size_type storage_linear::level_size(size_type Level) const
	{
		GLI_ASSERT(Level >= 0 && Level < this->levels());
	...
	storage_linear::size_type storage_linear::face_size(size_type BaseLevel, size_type MaxLevel) const
	{
	...
	storage_linear::size_type storage_linear::layer_size(
